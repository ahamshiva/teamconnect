...
(function () {
  ...
  TCL.Games.register({
    ...
    defaultSettings: { count: 4, writeSeconds: 90, voteSeconds: 45, categories: [], difficultyMin: 2, difficultyMax: 3, order: "random", pointsCorrect: 10, pointsPerFool: 5, minDefs: 4, useDecoys: true, unusedOnly: true, scoringEnabled: true, sound: true },
