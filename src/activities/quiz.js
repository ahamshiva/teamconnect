/* src/activities/quiz.js  Rapid-Fire Quiz. */
(function () {
  "use strict";
  ...
  TCL.Games.register({
    ...
    defaultSettings: { count: 10, seconds: 30, categories: [], difficultyMin: 2, difficultyMax: 3, order: "random", format: "mc", pointsByDifficulty: true, points: 10, pointsEasy: 10, pointsMedium: 15, pointsHard: 20, answerOrder: "turns", passPercent: 50, passLimit: 2, speedBonus: true, speedBonusPoints: 5, speedBonusMode: "tiered", negative: false, negativePoints: 5, stealing: true, attempts: "one", autoReveal: false, autoStart: true, unusedOnly: true, scoringEnabled: true, sound: true },
